 ...
 // setFormErrors({});
  ...
  const renderCycleOptions = () => (
    <div className="form-group">
      ...
      {(formData.diplomes === 'prepa' || formData.diplomes === 'cycle') && (
        <>
          <label>
            <input
              type="radio"
  ...
  return (
    <div className="container mt-5">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {formData.diplomes === 'bac' && renderLicenceOptions()}
        {(formData.diplomes === 'prepa' || formData.diplomes === 'cycle' || formData.diplomes === 'master') && renderCycleOptions()}
        {formData.diplomes === 'master' && renderMasterOptions()}
